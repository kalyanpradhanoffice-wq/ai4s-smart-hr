...
export const DEFAULT_ROLES = {
    ...
    MANAGER: {
        ...
        permissions: [
            ...
            // Interviews
            PERMISSIONS.SUBMIT_INTERVIEW_ASSESSMENT,
            // Feedback
            PERMISSIONS.SUBMIT_FEEDBACK, PERMISSIONS.VIEW_FEEDBACK,
...
export const LEAVE_TYPES = [
    ...
    { id: 'COMPOFF_CREDIT', name: 'Comp-Off Credit', color: '#10b981', maxPerYear: 0 },
    { id: 'COMPOFF', name: 'Compensatory Off', color: '#10b981', maxPerYear: 0 },
];

export const DEFAULT_SECURITY_CONFIG = {
    geofencingEnabled: true,
    officeLat: 22.486631342331854,
    officeLng: 88.31691389503489,
    officeRadius: 100, // meters
    officeLocationName: 'Main Office',
    geofenceMessage: 'Attendance Restricted: You must be within the office premises to punch in or out.',
};
...
export function applySandwichRule(fromDate, toDate, weekendType = 'sat_sun') {
