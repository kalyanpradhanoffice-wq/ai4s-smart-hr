...
export const DEFAULT_ROLES = {
    ...
    CORE_ADMIN: {
        ...
        permissions: [
            ...
            PERMISSIONS.VIEW_ALL_ATTENDANCE, PERMISSIONS.APPROVE_REGULARIZATION, PERMISSIONS.MANAGE_GEOFENCE,
            ...
            PERMISSIONS.MANAGE_NETWORK_SECURITY, PERMISSIONS.VIEW_AUDIT_LOGS, PERMISSIONS.MANAGE_APPROVAL_WORKFLOWS,
        ],
        isSystemRole: true,
    },
    HR_ADMIN: {
        ...
        permissions: [
            ...
            PERMISSIONS.VIEW_ALL_LEAVES, PERMISSIONS.APPROVE_LEAVE,
            PERMISSIONS.VIEW_ALL_PAYSLIPS, PERMISSIONS.RUN_PAYROLL,
            PERMISSIONS.SUBMIT_FEEDBACK, PERMISSIONS.VIEW_ALL_FEEDBACK,
            PERMISSIONS.MANAGE_ONBOARDING, PERMISSIONS.MANAGE_OFFBOARDING,
    ...
    MANAGER: {
        ...
        permissions: [
            ...
            PERMISSIONS.VIEW_OWN_PROFILE, PERMISSIONS.VIEW_OWN_PAYSLIP,
            PERMISSIONS.MANAGE_OKR, PERMISSIONS.SUBMIT_FEEDBACK, PERMISSIONS.VIEW_FEEDBACK,
            PERMISSIONS.APPLY_LEAVE, PERMISSIONS.MARK_ATTENDANCE,
        ],
        isSystemRole: true,
    },
    EMPLOYEE: {
...
export const LEAVE_TYPES = [
    { id: 'casual', name: 'Casual Leave', color: '#10b981', annualQuota: 12 },
    { id: 'sick', name: 'Sick Leave', color: '#ef4444', annualQuota: 8 },
    { id: 'earned', name: 'Earned Leave', color: '#6366f1', annualQuota: 15 },
    { id: 'maternity', name: 'Maternity Leave', color: '#ec4899', annualQuota: 180 },
    { id: 'paternity', name: 'Paternity Leave', color: '#8b5cf6', annualQuota: 15 },
    { id: 'unpaid', name: 'Unpaid Leave', color: '#94a3b8', annualQuota: 0 },
];
