...
export const DEFAULT_ROLES = {
    ...
    HR_ADMIN: {
        ...
        permissions: [
            ...
            PERMISSIONS.GIVE_KUDOS, PERMISSIONS.VIEW_KUDOS_BOARD,
            PERMISSIONS.MANAGE_FEEDBACK_CYCLES, PERMISSIONS.EXPORT_FEEDBACK_REPORTS,
            // Roles & Settings (read-only)
            PERMISSIONS.VIEW_ROLES, PERMISSIONS.VIEW_SYSTEM_SETTINGS,
        ],
        isSystemRole: true,
    },
    MANAGER: {
...
export const LEAVE_TYPES = [
    ...
    { id: 'maternity', name: 'Maternity Leave', color: '#ec4899', annualQuota: 180, applicableGender: 'female' },
    { id: 'paternity', name: 'Paternity Leave', color: '#8b5cf6', annualQuota: 15, applicableGender: 'male' },
